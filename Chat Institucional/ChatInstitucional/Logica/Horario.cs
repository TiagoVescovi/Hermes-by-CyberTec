...
namespace ChatInstitucional.Logica
{
    class Horario
    {
        ...
        {
            Validacion validacion = new Validacion();
            return validacion.Select("SELECT * FROM horario WHERE ciProfesor = " + ci + " AND activo = true;");
        }

        public DataTable HorariosPorDia(int ci, string day)
        {
            Validacion validacion = new Validacion();
            return validacion.Select("SELECT * FROM horario WHERE ciProfesor = " + ci + " AND dia = '" + day + "' AND activo = true;");
        }
