...
{
    public partial class AlumnoConsultaForm : Form
    {
        Validacion validacion = new Validacion();
        int IdConsulta = 0;


        public AlumnoConsultaForm()
        {
            InitializeComponent();
        }
        ...
        private void LlenarConsultas()
        {
            ...
            Dgv_Realizada.Columns[0].Visible = false;
            Dgv_Contestada.Columns[0].Visible = false;
            Dgv_Recibida.Columns[0].Visible = false;
        }
